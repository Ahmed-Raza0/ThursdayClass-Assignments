...
export default function Assignment() {
    return (
        <div className="flex flex-col sm:flex-row gap-4 my-4 bg-white shadow items-center justify-center h-auto w-full p-4">
            <div className="border-2 border-black border-dashed rounded w-full hover:scale-105 hover:shadow-2xl hover:shadow-black sm:w-1/3">
            ...
            <div className="border-2 border-black border-dotted rounded w-full hover:scale-105 hover:shadow-2xl hover:shadow-black sm:w-1/3">
            ...
            <div className="border-2 border-black border-double rounded w-full hover:scale-105 hover:shadow-2xl hover:shadow-black sm:w-1/3">
