...
export default function About() {
    return (
      <div className="bg-gray-100 min-h-screen flex flex-col items-center pt-16  my-5 ">
        <div className="w-full max-w-5xl p-5 bg-white shadow-lg rounded-lg mx-auto mb-5 mt-10">
